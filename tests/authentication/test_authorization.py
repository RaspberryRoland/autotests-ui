...
class TestAuthorization:
    ...
    def test_successful_authorization(
        ...
        registration_page.registration_form_component.fill(
            email='user.name@gmail.com', username='username',
            password='password')
        ...
        login_page.login_form_component.fill(email='user.name@gmail.com',
                                             password='password')
    ...
    def test_wrong_email_or_password_authorization(self, login_page: LoginPage,
        ...
        login_page.login_form_component.check_visible(email=email,
                                                      password=password)
        login_page.click_login_button()
